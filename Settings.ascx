<%@ Control Language="C#" AutoEventWireup="false" Inherits="DotNetNuke.Modules.EmbedSignature.Settings" Codebehind="Settings.ascx.cs" %>
...
<fieldset>
    <div class="dnnFormItem">
        <dnn:Label ID="lblGuid" Text="Signature form GUID" runat="server" /> 
